...
const ChatHeader: React.FC<ChatHeaderProps> = ({ onOpenPrivacy, onOpenSettings }) => {
    return (
        ...
        >
            ...
            {/* 3. Contenedor de Botones (Ajustes y Privacidad) */}
            <div className="flex items-center gap-2">
                
                {/* BOTÓN DE AJUSTES (Nuevo) */}
                <button
                    onClick={onOpenSettings} // 🚨 Llama a la función que abre el modal
                ...
                {/* BOTÓN DE POLÍTICA DE PRIVACIDAD (Existente) */}
                <button
